package com.smartagri.smartdecision.domain.repository;
...
public interface DeviceTelemetryRepository extends JpaRepository<DeviceTelemetry, Long> {
    ...
    List<DeviceTelemetry> findByDeviceIdAndReportTimeAfterOrderByReportTimeAsc(
            String deviceId, LocalDateTime after);
}
